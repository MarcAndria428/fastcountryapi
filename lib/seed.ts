...
const redis = new Redis({
  url: "https://humble-panther-76073.upstash.io",
  token: "gQAAAAAAASkpAAIgcDI5NGM4NDRiNmI1ZjA0NDRiOTI5ZGNkNjI4ZmIyOWMwYg",
});
...
const pipeline = countryList.map((country) => {
